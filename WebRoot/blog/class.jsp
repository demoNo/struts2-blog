...
<html>
  ...
  <body>
	...
	<div class="span-15" align="left">
		<c:forEach items="${requestScope.cessay}" var="es">
		     <div class="box">
    	 ...
    	 <s:url id="url_first" value="page/clsfir"></s:url>    	 
         <s:url id="url_pre" value="prec.action">     
           <s:param name="pageNow" value="page.pageNow-1"></s:param>     
         </s:url>        
         <s:url id="url_next" value="nextc.action">     
            <s:param name="pageNow" value="page.pageNow+1"></s:param>     
         </s:url>          
         <s:url id="url_last" value="page/clslas"></s:url>  
