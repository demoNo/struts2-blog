...
<html>
  <head>
    ...
    <!--[if IE]>
    <link rel="stylesheet" href="res/css/ie.css" type="text/css" media="screen, projection">
    <![endif]-->
  ...
  <body>
    <div id="headbar">
		...
		<div class="container">
			...
			<div class="span-24">
				<div class="box">
				    <p style="margin: 0px;" id="about">404 Not Found 懂不懂</p>
				    <p id="hehe">-_-!|</p>
				    <div id="find">
				      <form action="searchres">
                       <input type="text" id="search1" onfocus="if (this.value == '搜索...') {this.value = '';}" 
                       onblur="if (this.value == '') {this.value = '搜索...';}" value="搜索..." name="search" />
                      </form>
				    </div>
                </div>
			</div>
        ...
        <li><a href="mailto:email@hotmail.com">联系我们</a></li>
        <li><a href="">开发计划</a></li>
       </ul>
