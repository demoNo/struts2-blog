...
<html>
  <head>
    ...
    <title>My JSP 'sitemap.jsp' starting page</title>
  ...
  <body>
    <div id="headbar">
		...
		<div class="container">
			...
			<div class="span-24">
				<div class="box">
				    <c:forEach items="${requestScope.sitemap}" var="sm">
				    <div>
				       <p><strong><a href="essay/${ sm.date }/${ sm.essayid }">${sm.title}</a></strong></p>
				       <div id="post"><p>${ sm.author } <span style="color: #95006D">post@</span> ${sm.date} ${sm.classification} <span>共${sm.comments}条评论</span></p></div> 
				    </div>
				    </c:forEach>
                </div>
			</div>
